...
| GPU | pre-resource A660 GMU resume entry and complete rollback pass live; v9 is consumed | v3 accepts registration, v4 exact SQE/GMU requests, and v7 raw-size-pinned allocation/rollback with equal settled GEM state; v8 safely diagnosed signed-width and process-global PM-oracle errors; the [sole v9 cycle](../test-results/2026-07-27-a660-gmu-resume-entry-v9-live-accepted.md) accepts one GPU-device outer runtime-PM transition and complete rollback; the [v10 kernel tier](../test-results/2026-07-27-a660-gmu-cx-runtime-pm-v10-offline.md), [runtime oracle](../test-results/2026-07-27-a660-gmu-cx-runtime-pm-v10-runtime-offline.md), [protected-root/pre-live HOLD](../test-results/2026-07-27-a660-gmu-cx-runtime-pm-v10-prelive-hold.md), and [current readiness HOLD](../test-results/2026-07-27-a660-gmu-cx-runtime-pm-v10-current-readiness-hold.md) pass exact GMU/linked-CX classification, fourteen runtime mutations, recursive root verification, current one-shot controls, verifier-first server isolation, unarmed state preservation, and exact fallback preflight while config/Image/ABI and every other installed module remain accepted-v8-identical | v10 is selected; complete a fresh attended GO review, then at most one RAM-only cycle; require zero GX/clock/MMIO/IRQ/firmware-start/HFI activity and consume v10 regardless of result; no live authority yet |
| Wi-Fi/hotspot | passing | ath11k modules plus namespace packet tests for VPN-only forwarding, IPv4/IPv6 leak blocking, unsolicited isolation, VPN loss, and cleanup pass offline; the [real-WireGuard gate](../test-results/2026-07-27-vpn-hotspot-wireguard-offline.md) accepts a kernel handshake and encrypted hotspot packet, while the [v2 DNS/recovery gate](../test-results/2026-07-27-vpn-hotspot-v2-dns-recovery-offline.md) adds UDP/TCP DNS framing, one-way leak detection, endpoint/interface loss, recovery, and exact cleanup | board PCIe/power/calibration/firmware, on-phone/provider WireGuard handshake, AP/DHCP/provider-DNS, and device packet/thermal tests |
