...
| GPU | exact firmware requests and rollback-safe ucode-allocation build pass; power/open pending | v3 accepts registration and v4 accepts exact SQE/GMU requests; v5 safely exposed an inlining-blind wrapper oracle; v6 passed its [offline](../test-results/2026-07-26-a660-ucode-allocation-v6-offline.md), [HOLD](../test-results/2026-07-26-a660-ucode-allocation-v6-prelive-hold.md), and [GO](../test-results/2026-07-26-a660-ucode-allocation-v6-prelive-go.md) reviews, but the [sole live cycle](../test-results/2026-07-26-a660-ucode-allocation-v6-live-rejected.md) rejected raw sizes `43288/4/4096` against page-rounded expectations before the mandatory snapshot; watchdog fallback and cleanup passed; v5/v6 are consumed | build and offline-review v7 with the corrected raw-size oracle and equal settled snapshot, then separately test GMU resume/ZAP, successful open, submission, and rendering; acceleration remains pending |
