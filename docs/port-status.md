...
| GPU | exact firmware requests and rollback-safe ucode allocation pass; GMU resume-entry v8 passes offline only | v3 accepts registration and v4 accepts exact SQE/GMU requests; v5/v6 diagnose userspace oracles and are consumed; the [sole v7 live cycle](../test-results/2026-07-26-a660-ucode-allocation-v7-live-accepted.md) accepts raw-size-pinned allocation, exact rollback, logical `4/4`, and equal settled GEM state with zero later hardware activity; v7 is consumed; the [v8 source boundary](../test-results/2026-07-26-a660-gmu-resume-entry-boundary.md), [duplicate clean build](../test-results/2026-07-26-a660-gmu-resume-entry-v8-offline.md), [runtime/relocation gate](../test-results/2026-07-26-a660-gmu-resume-entry-v8-runtime-offline.md), [protected root/target gate](../test-results/2026-07-26-a660-gmu-resume-entry-v8-root-offline.md), and [one-shot host runner/HOLD](../test-results/2026-07-26-a660-gmu-resume-entry-v8-prelive-hold.md) pass offline while stopping before every inner GMU resource operation; v8 remains HOLD and absent from NFS | perform the attended unchanged-package/fallback review and add only one verifier-first exact-root GO window before any RAM-only entry test; then isolate GMU power, HFI, and ZAP/SCM in separate tiers before successful open, submission, or rendering |
