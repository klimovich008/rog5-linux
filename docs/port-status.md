...
| GPU | exact firmware requests and rollback-safe ucode-allocation pass; power/open pending | v3 accepts registration and v4 accepts exact SQE/GMU requests; v5 exposed a compiler-inlining-blind wrapper oracle; v6 exposed a raw/page-size oracle mismatch; v5/v6 are consumed; the v7 [offline](../test-results/2026-07-26-a660-ucode-allocation-v7-offline.md), [HOLD](../test-results/2026-07-26-a660-ucode-allocation-v7-prelive-hold.md), and [GO](../test-results/2026-07-26-a660-ucode-allocation-v7-prelive-go.md) chain passes, and its [sole live cycle](../test-results/2026-07-26-a660-ucode-allocation-v7-live-accepted.md) accepts raw-size-pinned allocation, exact rollback, logical `4/4`, and equal settled GEM state with zero later hardware activity; v7 is consumed | isolate runtime power, GMU resume/HFI, and ZAP/SCM before any successful open, submission, or rendering; acceleration remains pending |
