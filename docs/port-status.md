...
| GPU | pre-resource A660 GMU resume entry and complete rollback pass live; v9 is consumed | v3 accepts registration, v4 exact SQE/GMU requests, and v7 raw-size-pinned allocation/rollback with equal settled GEM state; v8 safely diagnosed signed-width and process-global PM-oracle errors; the [sole v9 cycle](../test-results/2026-07-27-a660-gmu-resume-entry-v9-live-accepted.md) accepts one GPU-device outer runtime-PM transition and complete rollback; the [v10 kernel tier](../test-results/2026-07-27-a660-gmu-cx-runtime-pm-v10-offline.md), [runtime oracle](../test-results/2026-07-27-a660-gmu-cx-runtime-pm-v10-runtime-offline.md), and [protected-root/pre-live HOLD](../test-results/2026-07-27-a660-gmu-cx-runtime-pm-v10-prelive-hold.md) now pass exact GMU/linked-CX classification, fourteen runtime mutations, recursive root verification, one-shot controls, and verifier-first server isolation while config/Image/ABI and every other installed module remain accepted-v8-identical | complete a fresh attended GO review, then at most one RAM-only v10 cycle; require zero GX/clock/MMIO/IRQ/firmware-start/HFI activity and consume v10 regardless of result; no live authority yet |
