...
| GPU | rejected: KGSL second-open fault | v15 makes DISPCC active, completes seven formerly stalled RCG reads, and advances GPUCC through index 6; v16 never entered the target; v17 offline-accepts the same trace-free target with atomic load-to-execute transport | run one v17 full GPUCC bind/stability confirmation; then continue power-domain/clock/regulator/IOMMU/GMU/firmware and full Tier 5 validation |
