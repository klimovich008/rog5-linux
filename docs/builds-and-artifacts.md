...
| A660/GMU registration tier | separate registration from first DRM open before building a live candidate | full graph, guarded modular kernel, and exact four-node DT pass offline and reproduce byte-for-byte; runtime bundle and live gates pending |
