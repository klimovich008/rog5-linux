...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, and six `6aa47517…d398` are consumed, absent from boot policy, and never reusable. Generations 4–6 are deterministic AVB-only successors over unchanged raw recovery `f1a7c5ad…6a4ce`; AVB remains algorithm `NONE`. Generation 4 missed the 45-second transfer-completion/NFS handoff ([issuance](../test-results/2026-08-03-generation-4-timeout-lattice-offline.md), [live](../test-results/2026-08-03-generation-4-nfs-readiness-live.md), [correction](../test-results/2026-08-03-generation-4-choreography-fix-offline.md)). Generation 5 transferred all 46,163,787 bytes but inherited a blocked TERM mask and waited for its 205-second watchdog before cleanup ([issuance](../test-results/2026-08-03-generation-5-choreography-offline.md), [admission](../test-results/2026-08-03-generation-5-live-admission-offline.md), [live](../test-results/2026-08-03-generation-5-nfs-readiness-live.md), [signal correction](../test-results/2026-08-03-generation-5-signal-mask-choreography-fix-offline.md)). Generation 6 passed [connected preflight](../test-results/2026-08-03-generation-6-connected-preflight-live.md), booted once, and transferred the complete bundle while recovery control remained silent; independently, the collector expired with zero target frames. No COMMIT intent existed and no target ran. Alpine restoration and strict SSH passed. Automated cleanup returned FAIL on the real fallback udev-model mismatch, while independent residue checks were clean. See the [issuance](../test-results/2026-08-03-generation-6-signal-fix-offline.md), [admission](../test-results/2026-08-03-generation-6-live-admission-offline.md), and [live result](../test-results/2026-08-03-generation-6-recovery-control-silence-live.md). Historical generations 1–3 remain indexed in the [archive](archive-index.md). |
