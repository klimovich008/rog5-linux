...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, six `6aa47517…d398`, seven `d3d4cdb9…12901`, and eight `f102d53c…f2415` are consumed, absent from boot policy, and never reusable. Generations 4–8 are deterministic AVB-only successors over unchanged raw recovery `f1a7c5ad…6a4ce`; AVB remains algorithm `NONE`. Generation 8 passed connected preflight, booted once in RAM, and transferred the complete signed bundle, but recovery control rejected because recovery ACM identity did not remain stable; no `PREPARED`, COMMIT intent, target frame, or target execution existed. Exact Alpine restoration and strict SSH passed. Its final host proof exposed a separate empty root-owned mode-`0600` NFS export-table inspection defect while independent checks found no residue. The host-only correction now proves that table read-only through the fixed privileged broker without changing its mode; the next successor requires bounded recovery-ACM stability classification. See the [Generation-8 offline successor](../test-results/2026-08-03-generation-8-nmcli-empty-field-successor-offline.md), [profile transition](../test-results/2026-08-03-generation-8-live-profile-offline.md), [admission](../test-results/2026-08-03-generation-8-live-admission-offline.md), [consumed live result](../test-results/2026-08-03-generation-8-recovery-acm-stability-live.md), and historical [archive](archive-index.md). |
