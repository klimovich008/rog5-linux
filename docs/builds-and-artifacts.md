...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, six `6aa47517…d398`, seven `d3d4cdb9…12901`, eight `f102d53c…f2415`, and nine `b458e64b…d008` are consumed, absent from boot policy, and never reusable. Generation 9 transferred all 46,163,787 signed-bundle bytes over exact recovery ACM/NCM but returned no `PREPARED` response before watchdog fallback; no COMMIT intent or target execution occurred, and exact Alpine fallback plus final cleanup passed. The replacement responder now retains five bounded PREPARE phases and is byte-verified in twin initramfses, clean ASUS wrapper Images, and raw/unsigned-AVB test repacks (`authority=none`, disposable key destroyed). This hardware-free checkpoint embeds the instrumentation but does not locate the post-transfer gap. No Generation 10 was issued or booted; any successor lifecycle remains diagnostic-only and requires a production-signed immutable profile plus the existing admission/fallback gates. See the Generation-9 [live result](../test-results/2026-08-03-generation-9-prepared-response-gap-live.md), [progress result](../test-results/2026-08-03-prepare-progress-observability-offline.md), [wrapper integration](../test-results/2026-08-03-prepare-progress-wrapper-integration-offline.md), and historical [archive](archive-index.md). |
