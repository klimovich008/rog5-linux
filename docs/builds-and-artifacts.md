...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, and five `abe4501f…beb1a` are consumed and absent from boot policy. Generation 4 was independently reproduced twice over unchanged raw recovery `f1a7c5ad…6a4ce`, passed connected preflight, and booted once in RAM. Recovery ACM/NCM, rollback, collector readiness, and bundle-service readiness passed, but the service never emitted its independent completion marker before control's 45-second NFS-readiness deadline. NFS did not start, COMMIT was never sent, and no target ran. The corrected lifecycle covers that exact PREPARED/control-exits-first stall, anchored fallback, cleanup, and artifact progress; corrected installed host bundle/NFS preflights pass. Generation 5 was then reproduced twice over the same unchanged raw recovery, passed connected preflight, and booted once in RAM. Recovery reached verified PREPARED and the host sent all 46,163,787 signed-bundle bytes, but the independent completion-to-NFS handoff still did not make the NFSv4.2 listener ready before COMMIT. `execution_started` remained `NO`; no target ran. Once the controller watchdog released its lock, anchored profile restoration, exact Alpine strict SSH, installed bundle/root preflights, and final host cleanup passed. Private timestamps prove the transfer finished about 46 seconds before rejection; the broker had propagated a blocked TERM mask into the controller and watchdog, preventing normal completion until the 205-second watchdog expired. The [offline signal correction](../test-results/2026-08-03-generation-5-signal-mask-choreography-fix-offline.md) fixes that process lifecycle without increasing a timeout. The [host checkpoint](../test-results/2026-08-03-generation-5-signal-mask-host-install-live.md) installs the exact corrected broker, passes both real host-only preflights, and proves clean residue. Generation 5 is consumed and must never be retried or flashed. Generation 6 `6aa47517…d398` is twin-reproduced over the unchanged accepted payload after the signal-mask fix. Its exact artifact and mutation gates pass; the lifecycle selects its distinct live-capable profile while its immutable offline profile still refuses phone actions. Central policy admits exactly one connected-preflight-gated RAM-only cycle. It remains unbooted and may never be flashed. AVB remains algorithm `NONE`, so trust is the pinned host identity plus embedded production Ed25519 root. See the [generation-1 result](../test-results/2026-08-02-listener-successor-avb-generation-offline.md), [NFS-bypass result](../test-results/2026-08-02-diagnostic-nfs-handoff-bypass-live.md), [generation-2 live result](../test-results/2026-08-02-generation-2-fresh-fetch-gap-live.md), [generation-3 production build](../test-results/2026-08-02-generation-3-fresh-fetch-production-build.md), [generation-3 live result](../test-results/2026-08-03-generation-3-transfer-timeout-live.md), [generation-4 offline issuance](../test-results/2026-08-03-generation-4-timeout-lattice-offline.md), [generation-4 live result](../test-results/2026-08-03-generation-4-nfs-readiness-live.md), [host correction](../test-results/2026-08-03-generation-4-choreography-fix-offline.md), [generation-5 offline issuance](../test-results/2026-08-03-generation-5-choreography-offline.md), [generation-5 admission](../test-results/2026-08-03-generation-5-live-admission-offline.md), [generation-5 live result](../test-results/2026-08-03-generation-5-nfs-readiness-live.md), [generation-6 offline result](../test-results/2026-08-03-generation-6-signal-fix-offline.md), [generation-6 profile transition](../test-results/2026-08-03-generation-6-live-profile-offline.md), and [generation-6 admission](../test-results/2026-08-03-generation-6-live-admission-offline.md) |
