...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, six `6aa47517…d398`, seven `d3d4cdb9…12901`, eight `f102d53c…f2415`, and nine `b458e64b…d008` are consumed, absent from boot policy, and never reusable. Generation 9 transferred all 46,163,787 signed-bundle bytes over exact recovery ACM/NCM but returned no `PREPARED` response before watchdog fallback; no COMMIT intent or target execution occurred, and exact Alpine fallback plus final cleanup passed. The complete transfer and USB timeline make replay discovery after transport loss the best interpretation of its final product-mismatch trace, but the controller did not label the phase directly. Do not issue Generation 10 until hardware-free replay diagnostics and bounded recovery-side phase evidence locate the post-transfer gap. See the Generation-9 [offline successor](../test-results/2026-08-03-generation-9-acm-classifier-successor-offline.md), [profile transition](../test-results/2026-08-03-generation-9-live-profile-offline.md), [admission](../test-results/2026-08-03-generation-9-live-admission-offline.md), [live result](../test-results/2026-08-03-generation-9-prepared-response-gap-live.md), and historical [archive](archive-index.md). |
