...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, and four `220e8556…270d` are consumed. Generation 4 was independently reproduced twice over unchanged raw recovery `f1a7c5ad…6a4ce`, passed connected preflight, and booted once in RAM. Recovery ACM/NCM, rollback, collector readiness, and bundle-service readiness passed, but the service never emitted its independent completion marker before control's 45-second NFS-readiness deadline. NFS did not start, COMMIT was never sent, and no target ran. The corrected lifecycle now covers that exact stall, automatic anchored fallback, host cleanup, PREPARED visibility, and artifact progress; corrected installed host bundle/NFS preflights pass. Distinct Generation-5 AVB `abe4501f…beb1a` is reproduced twice over the unchanged raw payload and passes the exact artifact/mutation gate. Exactly one central-policy row admits at most one connected-preflight-gated RAM-only lifecycle; the image is unbooted and unconsumed. AVB remains algorithm `NONE`, so trust is the pinned host identity plus embedded production Ed25519 root. See the [generation-1 result](../test-results/2026-08-02-listener-successor-avb-generation-offline.md), [NFS-bypass result](../test-results/2026-08-02-diagnostic-nfs-handoff-bypass-live.md), [generation-2 live result](../test-results/2026-08-02-generation-2-fresh-fetch-gap-live.md), [generation-3 production build](../test-results/2026-08-02-generation-3-fresh-fetch-production-build.md), [generation-3 live result](../test-results/2026-08-03-generation-3-transfer-timeout-live.md), [generation-4 offline issuance](../test-results/2026-08-03-generation-4-timeout-lattice-offline.md), [generation-4 live result](../test-results/2026-08-03-generation-4-nfs-readiness-live.md), [host correction](../test-results/2026-08-03-generation-4-choreography-fix-offline.md), [generation-5 offline issuance](../test-results/2026-08-03-generation-5-choreography-offline.md), and [generation-5 admission](../test-results/2026-08-03-generation-5-live-admission-offline.md) |
