...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, and six `6aa47517…d398` are consumed, absent from boot policy, and never reusable. Generations 4–7 are deterministic AVB-only successors over unchanged raw recovery `f1a7c5ad…6a4ce`; AVB remains algorithm `NONE`. Generation 4 missed the transfer/NFS handoff, Generation 5 exposed an inherited blocked TERM mask, and Generation 6's empty control log was caused by two host cleanup-verifier defects rather than proven recovery silence. No COMMIT intent existed and no target ran in generations 4 or 6. Distinct unbooted Generation 7 `d3d4cdb9…12901` incorporates the exact udev-model and retained-profile-association host corrections. Its two issuer trees are byte-identical, exact artifact and hostile mutation gates pass, and a separate lifecycle-only profile selects the same tuple while direct boot remains rejected. Central policy admits exactly one connected-preflight-gated RAM-only lifecycle. See the [Generation-7 issuance](../test-results/2026-08-03-generation-7-deferred-profile-fix-offline.md), [profile transition](../test-results/2026-08-03-generation-7-live-profile-offline.md), [one-shot admission](../test-results/2026-08-03-generation-7-live-admission-offline.md), [Generation-6 reconstruction](../test-results/2026-08-03-generation-6-deferred-profile-association-fix-offline.md), and historical [archive](archive-index.md). |
