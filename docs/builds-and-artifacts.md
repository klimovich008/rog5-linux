...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, six `6aa47517…d398`, and seven `d3d4cdb9…12901` are consumed, absent from boot policy, and never reusable. Generations 4–7 are deterministic AVB-only successors over unchanged raw recovery `f1a7c5ad…6a4ce`; AVB remains algorithm `NONE`. Generation 8 `f102d53c…f2415` is the next deterministic AVB-only successor over that same raw recovery; it is host-locally twin-issued, pinned by offline/live profile twins, selected by the lifecycle, and unbooted. Its offline issuance record retains `authority=none`, while central policy separately admits one connected-preflight-gated RAM-only lifecycle. Generation 7 passed connected preflight, booted once in RAM, and transferred the complete signed bundle, but produced no `PREPARED` or target frame before the fixed deadline; no COMMIT intent existed and no target ran. Anchored Alpine restoration and strict SSH passed. The exposed cleanup defects are reproduced and fixed offline without extending deadlines or weakening residue checks. See the [Generation-8 offline successor](../test-results/2026-08-03-generation-8-nmcli-empty-field-successor-offline.md), [Generation-8 profile transition](../test-results/2026-08-03-generation-8-live-profile-offline.md), [Generation-8 admission](../test-results/2026-08-03-generation-8-live-admission-offline.md), [Generation-7 issuance](../test-results/2026-08-03-generation-7-deferred-profile-fix-offline.md), [profile transition](../test-results/2026-08-03-generation-7-live-profile-offline.md), [one-shot admission](../test-results/2026-08-03-generation-7-live-admission-offline.md), [connected preflight](../test-results/2026-08-03-generation-7-connected-preflight-live.md), [consumed live result](../test-results/2026-08-03-generation-7-acm-stability-live.md), [cleanup correction](../test-results/2026-08-03-generation-7-cleanup-snapshot-fix-offline.md), [empty-field correction](../test-results/2026-08-03-generation-7-nmcli-empty-field-fix-offline.md), [Generation-6 reconstruction](../test-results/2026-08-03-generation-6-deferred-profile-association-fix-offline.md), and historical [archive](archive-index.md). |
