...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, six `6aa47517…d398`, and seven `d3d4cdb9…12901` are consumed, absent from boot policy, and never reusable. Generations 4–7 are deterministic AVB-only successors over unchanged raw recovery `f1a7c5ad…6a4ce`; AVB remains algorithm `NONE`. Generation 7 passed connected preflight, booted once in RAM, and transferred the complete signed bundle, but produced no `PREPARED` or target frame before the fixed deadline; no COMMIT intent existed and no target ran. Anchored Alpine restoration and strict SSH passed. The final cleanup deadline failure is reproduced offline and corrected by reducing one strict firewalld-backed observation from about 5.72 to 1.11 seconds without extending the deadline or weakening residue checks; transitional UUID evidence remains fail-closed and privacy-preserving. See the [Generation-7 issuance](../test-results/2026-08-03-generation-7-deferred-profile-fix-offline.md), [profile transition](../test-results/2026-08-03-generation-7-live-profile-offline.md), [one-shot admission](../test-results/2026-08-03-generation-7-live-admission-offline.md), [connected preflight](../test-results/2026-08-03-generation-7-connected-preflight-live.md), [consumed live result](../test-results/2026-08-03-generation-7-acm-stability-live.md), [cleanup correction](../test-results/2026-08-03-generation-7-cleanup-snapshot-fix-offline.md), [Generation-6 reconstruction](../test-results/2026-08-03-generation-6-deferred-profile-association-fix-offline.md), and historical [archive](archive-index.md). |
