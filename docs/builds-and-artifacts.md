...
| locked Arch Plasma rootfs | headless-first target with Plasma/KRDP and browser/network tools | manifest-pinned 2,007,186,653-byte network-root archive passes live headless gates; the [packaging audit](../test-results/2026-07-27-arch-userspace-readiness-offline.md) adds the isolated, resource-bounded `rog5-agent` and fixes a hotspot/dnsmasq systemd cycle; the [2,006,999,039-byte successor](../test-results/2026-07-27-arch-successor-rootfs-offline.md), its [read-only Btrfs export](../test-results/2026-07-27-arch-successor-protected-export-offline.md), and [pre-live v1 controls](../test-results/2026-07-27-arch-successor-v1-prelive-hold.md) pass; the newer [2,007,001,876-byte successor v2](../test-results/2026-07-27-arch-successor-v2-rootfs-offline.md) adds fail-closed hotspot transitions, its separate [protected v2 export](../test-results/2026-07-27-arch-successor-v2-protected-export-offline.md) passes recursive verification plus four mutations, and its [pre-live v2 controls](../test-results/2026-07-27-arch-successor-v2-prelive-hold.md) pass mocked plus actual-unarmed checks; v1 is unchanged and v2 remains unserved, unbooted, and HOLD |
