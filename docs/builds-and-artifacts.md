...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, six `6aa47517…d398`, seven `d3d4cdb9…12901`, and eight `f102d53c…f2415` are consumed, absent from boot policy, and never reusable. Generation 9 is a distinct 100,663,296-byte AVB-only successor `b458e64b…d008` over unchanged raw recovery `f1a7c5ad…6a4ce`; both retained host-local twins and exact offline/live profiles pass. Issuance remains `authority=none`, while central policy separately admits exactly one connected-preflight-gated RAM-only lifecycle with removal after any result and no retry or flash. It remains unbooted until the admission is published and exact-head CI passes. See the Generation-9 [offline successor](../test-results/2026-08-03-generation-9-acm-classifier-successor-offline.md), [profile transition](../test-results/2026-08-03-generation-9-live-profile-offline.md), [admission](../test-results/2026-08-03-generation-9-live-admission-offline.md), and historical [archive](archive-index.md). |
