...
| ASUS WCN6855/PCIe tier | opt-in PCIe0, QMP PHY, PMU/regulator, MHI, and ath11k bring-up | [offline acceptance](../test-results/2026-07-27-wcn6855-pcie-offline.md) passes immutable-base mutations, pinned upstream schemas, exact module/alias checks, and two byte-identical Linux 7.1.4 builds; not packaged or booted; radio HOLD |
