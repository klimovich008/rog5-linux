...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, and four `220e8556…270d` are consumed; no diagnostic image is admitted. Generation 4 was independently reproduced twice over unchanged raw recovery `f1a7c5ad…6a4ce`, passed connected preflight, and booted once in RAM. Recovery ACM/NCM, rollback, collector readiness, and bundle-service readiness passed, but the service never emitted its independent completion marker before control's 45-second NFS-readiness deadline. NFS did not start, COMMIT was never sent, and no target ran. The phone returned automatically to Alpine; after the 205-second host watchdog, fixed anchored profile restoration and strict fallback preflight passed without project server/export residue. Its policy row is removed, inventory role is consumed/offline-only, both policy tests require absence, and downstream compatibility hashes are repinned. AVB remains algorithm `NONE`, so trust is the pinned host identity plus embedded production Ed25519 root. The next distinct generation requires hardware-free PREPARE/completion-receipt/NFS choreography and early-failure cleanup coverage; see the [generation-1 result](../test-results/2026-08-02-listener-successor-avb-generation-offline.md), [NFS-bypass result](../test-results/2026-08-02-diagnostic-nfs-handoff-bypass-live.md), [generation-2 live result](../test-results/2026-08-02-generation-2-fresh-fetch-gap-live.md), [generation-3 production build](../test-results/2026-08-02-generation-3-fresh-fetch-production-build.md), [generation-3 live result](../test-results/2026-08-03-generation-3-transfer-timeout-live.md), [generation-4 offline issuance](../test-results/2026-08-03-generation-4-timeout-lattice-offline.md), [generation-4 live-profile transition](../test-results/2026-08-03-generation-4-live-profile-offline.md), [generation-4 admission](../test-results/2026-08-03-generation-4-live-admission-offline.md), and [generation-4 live result](../test-results/2026-08-03-generation-4-nfs-readiness-live.md) |
