...
| diagnostic recovery generations | preserve one-shot evidence while correcting the recovery transport | Generations zero `f710bbcd…97b0ef`, one `332889a8…b51830`, two `70fd77f7…fc72b1`, three `eb514a57…d77b6`, four `220e8556…270d`, five `abe4501f…beb1a`, six `6aa47517…d398`, seven `d3d4cdb9…12901`, eight `f102d53c…f2415`, and nine `b458e64b…d008` are consumed, absent from boot policy, and never reusable. Generation 9 transferred all 46,163,787 signed-bundle bytes over exact recovery ACM/NCM but returned no `PREPARED` response before watchdog fallback; no COMMIT intent or target execution occurred, and exact Alpine fallback plus final cleanup passed. The replacement responder retains five bounded PREPARE phases. A production-key-bound twin build embeds it in stable-recovery initramfs `99046d30…6e31`, clean ASUS wrapper Image `bb49b405…5f98`, and unchanged A/B raw wrapper `27f4dbcc…73b3`. Two independent Generation-10 issuances retain exact matching 11-file trees at AVB `b983e89b…8b51`; the key snapshot was destroyed, all records retain `authority=none`, and no phone interface was used. Generation 10 is unbooted, unprofiled, absent from inventory and boot policy, and remains diagnostic-only; any lifecycle requires a separately reviewed immutable profile plus the existing artifact, admission, rollback, fallback, and CI gates. See the Generation-9 [live result](../test-results/2026-08-03-generation-9-prepared-response-gap-live.md), [progress result](../test-results/2026-08-03-prepare-progress-observability-offline.md), [wrapper integration](../test-results/2026-08-03-prepare-progress-wrapper-integration-offline.md), [Generation-10 successor](../test-results/2026-08-03-generation-10-prepare-progress-successor-offline.md), and historical [archive](archive-index.md). |
