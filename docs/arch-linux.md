...
The earlier staged server-only rootfs is 1,028,140,049 bytes with SHA-256 `d2df10d8b198bc5656de4232b2153786a5e943050d3391277170b512cab6dd2c`. It passed the offline suite. The Plasma-bearing replacement is being staged and has no accepted artifact identity or live result yet.
