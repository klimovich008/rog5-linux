#!/usr/bin/env python3
"""Enter the fixed Generation-121 claim through the generic consumer."""
...
PROFILE = "local-image-stage-prebind-v12-generation121-live-v1"
EXPECTED = (
    b"format=rog5-temporary-boot-consumption-v1\n"
    b"recovery_profile=local-image-stage-prebind-v12-generation121-live-v1\n"
