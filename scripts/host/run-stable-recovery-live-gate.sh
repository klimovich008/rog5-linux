...
case $profile in
	...
	storage-layout-stage2-direct-extent20-seg3a-v1-generation219-live-v1)
		...
		expected_boot_basis='one exact Generation 219 direct p24 overwrite of extent-20 segment 3A at block 1464081 for 27204 blocks, with exact evidence, sync, relock and softdog disarm; RAM-only, never flash or retry after COMMIT'
		expected_boot_role='unbooted Generation 219 direct extent-20 segment 3A; never flash or retry after COMMIT'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
