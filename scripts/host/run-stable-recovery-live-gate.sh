...
case $profile in
	...
	local-image-direct-v46-generation155-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=local-image-direct-v46
		expected_bundle=local-image-direct-v46
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=9fece2e18feb30e62b6639ed0b9cdce41f6e206a3e974837e24ea30b4c5539d1
		expected_avb_digest=66a0e74a7a806622b1dcff61a0b684a32750b64cddfc64a17b389289797ba0fe
		expected_generation_record=56aa4120de2ea6f87820c1a404241288a9bf946e39554609b086ad2229834422
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 4872ce3609a87449ab309af201e5b06d8791306eb3240f27fbc0ef2e0fe4ce9b ]] || fail 'local-image direct V46 manifest is not pinned'
		[[ $expected_image == cba61981d5a120744bd366bbde05af5f30a8ff36b163223fe53fa62ea0705344 ]] || fail 'local-image direct V46 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'local-image direct V46 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'local-image direct V46 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	local-image-direct-v47-generation156-live-v1)
		expected_boot_image=build/local-image-direct-v47-generation156-20260825-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed by the sole Generation 156 cycle; prepare passed and extent 1 completed, but 4 KiB O_DIRECT made extent 2 run at about 0.6 MiB/s; operator ended the impossible-within-watchdog stream through SSH/HUP; exact fastboot fallback and cleanup passed; never retry or flash'
		expected_boot_role='consumed Generation 156 cycle; prepare and extent 1 passed, 4 KiB O_DIRECT throughput was impossible within watchdog, controlled SSH/HUP returned fastboot; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=4f9ac4e7afd4b5bf46a8a79188a0376406fcca294a8cc1648e4f0a44fc82d9f8
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=local-image-direct-v47
		expected_bundle=local-image-direct-v47
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=247e5a365c68a74a540bf3e414c546e90948f2ab48f6dad9fd9aa3197b9140d3
		expected_avb_digest=76c10f6a7c344df70f4d63f853b74807888396b92a723fc7d4b3f4aee6993d24
		expected_generation_record=e07a81ff5add95015ac669b2639d1c84c187cbcc4200427dd19928919576f809
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == d219de4fbfe7107c90c9fc2f8d92337f7cad916d4c3c767b55d2d4dd6a101a86 ]] || fail 'local-image direct V47 manifest is not pinned'
		[[ $expected_image == 7069dcc4bcd9a8475d8eea0a6d74d3ad09269ddeacb047a98d0c7afaaea56962 ]] || fail 'local-image direct V47 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'local-image direct V47 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'local-image direct V47 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	local-image-direct-v48-generation157-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=local-image-direct-v48
		expected_bundle=local-image-direct-v48
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=805b71d11e1bd3c1cd15edf2cdda7ab527c3d2075fa4ac55bb2e32705a703a42
		expected_avb_digest=3ebbbb763213f0e5b4394184a3d3dabd370873a0583e5334c76c8e9717a159d2
		expected_generation_record=e7017b5de5fb8e39ed1513754288e0871578135e79188ada56a1c4aa5c6da58c
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == b20c4ae492aecbf000c258456031c30f74847f816af347f40084d6c7569bbba2 ]] || fail 'local-image direct V48 manifest is not pinned'
		[[ $expected_image == a1bf83388dc820764af0735aaa32eddad416b24a97c10e23a6d9e383846316ac ]] || fail 'local-image direct V48 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'local-image direct V48 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'local-image direct V48 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	local-image-direct-v49-generation158-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=local-image-direct-v49
		expected_bundle=local-image-direct-v49
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=a46719927852884adabbae0033201d02de3ae353e38d4260bfc81c670c0d9d82
		expected_avb_digest=e193567ca05cc7d1d4866630e0feaeffe4a7e18cd4f46b78969667bbcaaf4840
		expected_generation_record=44a937e9b08fbef35bf6ac8ae8e6f1a90ae258b46d2dbed78971ad99d248747a
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == ac33ccf7cef86f43834f672d652537b7b5790c8949825f8449088a7721c30459 ]] || fail 'local-image direct V49 manifest is not pinned'
		[[ $expected_image == 00aa48f0258df05983f955095d355de8ef52c451bb2d4d7a352f4b3f5bafe027 ]] || fail 'local-image direct V49 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'local-image direct V49 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'local-image direct V49 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	persistent-root-local-v51-generation160-live-v1)
		...
		;;
	persistent-root-local-v52-generation161-live-v1)
		expected_boot_image=build/persistent-root-local-v52-generation161-20260825-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 161 read-only boot of the staged-seal 16 GiB local Arch image with the exact persistent-root USB identity and pre-reboot-mode stage reporting; userdata and image ro-noload, OverlayFS/systemd, power/USB, key-only SSH, controlled reboot, exact fastboot fallback; RAM-only; never flash or retry after entry'
		expected_boot_role='unbooted Generation 161 read-only local Arch successor with exact persistent-root host identity and pre-reboot-mode stage reporting; RAM-only, never flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=4f9ac4e7afd4b5bf46a8a79188a0376406fcca294a8cc1648e4f0a44fc82d9f8
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-root-local-v52
		expected_bundle=persistent-root-local-v52
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-gae717d919f87
		expected_target_timeout=600
		expected_avb_salt=3f47366418d4b0f4ba10881c1d32d3f9581dfc5a4f83113dc8637e2d0391a93e
		expected_avb_digest=517e3c81c97bb90fc7007520064d74811eb48f9f19107ceb775e10a2e7c90016
		expected_generation_record=9092770723e62c07e52d5deaa53829fc56872c8c832ebf4ea79bbcdbdff78ee7
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == f70e79df8684b5b17c8ce98a0e16bc7c9fbf82241673f2cb8d12de0d310b7b21 ]] || fail 'persistent-root local V52 manifest is not pinned'
		[[ $expected_image == 130d4eea6022969360a100a6427717ff2c7a45633770e7cbc7b92e85fd640fc1 ]] || fail 'persistent-root local V52 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'persistent-root local V52 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'persistent-root local V52 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	persistent-root-local-v53-generation162-live-v1)
		expected_boot_image=build/persistent-root-local-v53-generation162-20260825-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 162 read-only boot of the staged-seal 16 GiB local Arch image with reachable staged-seal absence verification; userdata and image ro-noload, OverlayFS/systemd, power/USB, key-only SSH, controlled reboot, exact fastboot fallback; RAM-only; never flash or retry after entry'
		expected_boot_role='unbooted Generation 162 read-only local Arch successor with reachable staged-seal absence policy; RAM-only, never flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=4f9ac4e7afd4b5bf46a8a79188a0376406fcca294a8cc1648e4f0a44fc82d9f8
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-root-local-v53
		expected_bundle=persistent-root-local-v53
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-gae717d919f87
		expected_target_timeout=600
		expected_avb_salt=edc90d45ad49717e6584f53e8ae1fdcd754bdb3a4c2685988e1fb4313519772d
		expected_avb_digest=b7d33cd4f65cc65bd80dba016ff57be174ce4c93b1147ad7f30d4b8376be998b
		expected_generation_record=904fbd6ad9571109f1036bad192b62e90a98b8e3529cc12e53921e0b80a85ed2
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 4a55d0f6010779abc0cc7ecc22367a1b75451b2fc3bfb26a4922d02557d316ca ]] || fail 'persistent-root local V53 manifest is not pinned'
		[[ $expected_image == d642f0e0f9a42e1bc308ae62d310bb35403417c4f671442074ecc9aac2092df3 ]] || fail 'persistent-root local V53 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'persistent-root local V53 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'persistent-root local V53 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	persistent-root-local-v54-generation163-live-v1)
		expected_boot_image=build/persistent-root-local-v54-generation163-20260825-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 163 repeat of the read-only local Arch server with the restart2 helper sealed into exitrd and exact-fastboot acceptance; RAM-only; never flash or retry after entry'
		expected_boot_role='unbooted Generation 163 repeat with restart2 helper in exitrd and exact-fastboot acceptance; RAM-only, never flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=4f9ac4e7afd4b5bf46a8a79188a0376406fcca294a8cc1648e4f0a44fc82d9f8
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-root-local-v54
		expected_bundle=persistent-root-local-v54
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-gae717d919f87
		expected_target_timeout=600
		expected_avb_salt=98606beea0b490fc8055e9181643ea9de2155726fc4708c35a4e8bcaafea3c68
		expected_avb_digest=91ec6ceb76991e09e4d0ffd22b241977cad63363e87d242e66d4197e10bc0d57
		expected_generation_record=11f1563f44c0c8e625f9af91e1d3bafb43a4f3562ae4024b94b5246dc2e4704d
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == af693192164aa50849639bed0e4cae3349dab3f66ea91f5979933b4b88fd0607 ]] || fail 'persistent-root local V54 manifest is not pinned'
		[[ $expected_image == e05a9d1d8ec27345344a3b70241a9c07f6e8600956af7f52d7453f457a482104 ]] || fail 'persistent-root local V54 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'persistent-root local V54 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'persistent-root local V54 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-mainline-readonly-v3-generation193-live-v1)
		...
		;;
	storage-layout-stage2-mainline-clone-v1-generation194-live-v1)
		expected_boot_image=build/storage-layout-stage2-mainline-clone-v1-generation194-20260826-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed by the sole Generation 194 cycle; mainline reached exact UFS/NCM/SSH, then the redundant 16 GiB source hash stalled UFS and NCM before any observed clone-WRITE marker; host NCM watchdog timed out, rollback returned exact fastboot after 19m31s, intent remains UNKNOWN, and p24 disposition requires read-only proof; never retry or flash'
		expected_boot_role='consumed ambiguous Generation 194 native p24 clone; source hash stalled UFS/NCM before any observed write marker, exact fastboot returned after 19m31s, p24 disposition unknown; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-mainline-clone-v1
		expected_bundle=storage-layout-stage2-mainline-clone-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=d9f3183d1ccd673f585ffb94e28f972c1a6c6f94ef2c17e64b2df0e5763e3e45
		expected_avb_digest=9614df9288112e97fd95cf307c298f5cb5570945a9c2c72b9a4a617d317acb98
		expected_generation_record=3ee7ebe6fc345a7998daf5c8a765db8e1f53518ebb80f1504bf97a48350b5a86
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 115fc705b9e3eb396ba75760ca0db4bae663ccc95fadc1ead21b84b874d97f06 ]] || fail 'native p24 clone manifest is not pinned'
		[[ $expected_image == 5cf38e13d9b694ed22dd02b18550817d2f10260d5581559f4078a7ee9db026e9 ]] || fail 'native p24 clone recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native p24 clone trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native p24 clone verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-native-postmortem-v1-generation195-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-native-postmortem-v1
		expected_bundle=storage-layout-stage2-native-postmortem-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=2a1f6370a86ec644061f5bace8818b6e5af28d1a60a2e51a717a4e9e2408f169
		expected_avb_digest=4d392b1647e2c2d06c5b21e921585900084081c801ab94e9f7202447e125eb7f
		expected_generation_record=1cde286fe60bf155e9b7b9aba3722952686f50bb1afc093223d989ec3267364c
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 307188a2c6d6630e8f5732d7d0b84e297a6dd171cc687100a4714a565b4303f1 ]] || fail 'native p24 postmortem manifest is not pinned'
	...
	storage-layout-stage2-mainline-clone-v2-generation196-live-v1)
		...
		expected_boot_basis='consumed Generation 196 prewrite watchdog probe; exact UFS passed, qcom-wdt load/open advanced to the optional timeout-sysfs check, then failed closed because CONFIG_WATCHDOG_SYSFS is disabled; no p24 write, exact slot-A fastboot and intent fallback resolution passed; never retry or flash'
		expected_boot_role='consumed Generation 196 prewrite watchdog probe; failed only optional timeout sysfs under CONFIG_WATCHDOG_SYSFS=n, no p24 write, exact fastboot/fallback passed; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
	...
	storage-layout-stage2-mainline-clone-v3-generation197-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-mainline-clone-v3
		expected_bundle=storage-layout-stage2-mainline-clone-v3
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=ac8d26f163f5ca5f1c0806d19f781cf43e4294c0f01b1a42ba6efadeee862a5a
		expected_avb_digest=22942b4587fb1a01610f537ff685e97f3b014f78382c950112fca29444e28481
		expected_generation_record=313760eb8c7674bd39dc3af68e6a4105ebdacad9297f4c827f0300ee3ab73a15
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == dd3455a16c59c61d56d78636c3de94a9230e9d25aa895f36834d9e041dfcd6a3 ]] || fail 'native p24 clone v3 manifest is not pinned'
	...
	storage-layout-stage2-watchdog-lifetime-v1-generation200-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-watchdog-lifetime-v1
		expected_bundle=storage-layout-stage2-watchdog-lifetime-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=0c723e850509642bf7ba8bd8a000b16a9c7a577d72047e47a78bb23dbe9da2d8
		expected_avb_digest=48cee6ac15d4a7d9b0609a28c509561f37107876411d80545001dc447eea4ee8
		expected_generation_record=503c7b7f236d38ec45ddcb6c056d25ee9f06b4759506a550f006c1f2dc5c3ca4
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 8544f57d85d0a75af067fa02ec2747f01a6c0fa6c666b94a5ea0931b61444452 ]] || fail 'watchdog lifetime manifest is not pinned'
		[[ $expected_image == 5e4bdaeb27e658f62d65e82c3f3081b05ac7d3caf87ee86223ecf1e9e53bd4a9 ]] || fail 'watchdog lifetime recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'watchdog lifetime trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'watchdog lifetime verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-watchdog-observer-v2-generation203-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-watchdog-observer-v2
		expected_bundle=storage-layout-stage2-watchdog-observer-v2
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=feab8d41e6fdfa3d63d5f32e25be8b2a9b5031585cee2007334ea3fb5491c9f4
		expected_avb_digest=b890b24a0530a2c0f7ddb27ac76bfd6d83e667aa4e51cdc77539343e93b35336
		expected_generation_record=f69068469a8aaf200c9cee317bcf91d5fb5dfe3a12ba66a4eaef11e2d32dacf6
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == e984aa8be8b6d3ce24071035edfbd63e73b8fc08a32a2b5c31b9e63a9562cdb1 ]] || fail 'early watchdog observer manifest is not pinned'
	...
	storage-layout-stage2-watchdog-mmio-v1-generation204-live-v1)
		...
		expected_boot_basis='consumed Generation 204 MMIO-read classifier; target reported watchdog-mmio-detail before writes, proving the pipeline masked an empty or invalid register read; exact fastboot and FALLBACK_RETURNED passed, no storage writes; never retry or flash'
		expected_boot_role='consumed Generation 204 pipeline-masked MMIO read failure; exact fallback, no writes; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
	...
	storage-layout-stage2-watchdog-mmio-v2-generation205-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-watchdog-mmio-v2
		expected_bundle=storage-layout-stage2-watchdog-mmio-v2
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=68f51276982b42fa001272ede1513ff3c8ef78b4b52fad624bf6a4b6b9911f72
		expected_avb_digest=44d9fd391434facab5b8e0b80b79a5537158a1e2544e531c9dd221d33f2a8827
		expected_generation_record=62baf075578536f2bbd0fa85a496967636b04e913b73846daaae600a37d97041
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 436f32b67473360af215486d275966cc9b3504dfaf9b6e3a704f5ce8a188dcd0 ]] || fail 'finite MMIO manifest is not pinned'
		[[ $expected_image == c456a202220c431e7ff55f6bb696242a2eb2916b8bf896ef07cc7220e92d3539 ]] || fail 'finite MMIO recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'finite MMIO trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'finite MMIO verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-watchdog-mmap-v1-generation206-live-v1)
		expected_boot_image=build/storage-layout-stage2-watchdog-mmap-v1-generation206-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed Generation 206 APSS-MMIO classifier; read-only mmap succeeded but first register access raised SIGBUS, exact fastboot and FALLBACK_RETURNED passed, no storage path; never retry or flash'
		expected_boot_role='consumed Generation 206 APSS MMIO SIGBUS; exact fallback, no writes; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-watchdog-mmap-v1
		expected_bundle=storage-layout-stage2-watchdog-mmap-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=19173628f6a8c081e5f907b37100c70631989a6bdb2fe038cecff3d510b7caf2
		expected_avb_digest=a2c9c0efdd2b348e25229575e3d02505572bde917fe11e9874f3bfc0dcf6ec40
		expected_generation_record=cf03bff5eed4dc9ea3aa9b15cc9ff3ff6ed03b652e66b8ea8315cfe7d8d89526
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 840e40b59cd266f9545773c971f38e85ded0165349b3b61997dcb1f6f5ee7d97 ]] || fail 'mmap watchdog manifest is not pinned'
		[[ $expected_image == 87807c2cdad742674dec4dfbc532f651e13da597cb2d39a583478cef64c2bc9f ]] || fail 'mmap watchdog recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'mmap watchdog trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'mmap watchdog verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-softdog-probe-v1-generation207-live-v1)
		expected_boot_image=build/storage-layout-stage2-softdog-probe-v1-generation207-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed successful Generation 207 softdog proof; exact armed stage then automatic slot-A fastboot in 23.6 seconds, TARGET_ACCEPTED, no UFS or storage access; never retry or flash'
		expected_boot_role='consumed successful Generation 207 softdog fastboot-expiry proof; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-softdog-probe-v1
		expected_bundle=storage-layout-stage2-softdog-probe-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=a6cbde84ed07ae14b6601f4dbcec4177b56ff1392ab3277f675ea80babd00432
		expected_avb_digest=c6c3b6eeb0b818245b0d56bb3bbe32b413b7e029fd12d9cf18236ef35376c61c
		expected_generation_record=4ea1e30e026451c8b5a19929399c1b5fc6b58e75688c3c400c27105c5fab7f88
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == ec5d0890e83589c9b564908a511d266c873e9d7f5a76d7c16b4024e0c5dd8344 ]] || fail 'softdog manifest is not pinned'
		[[ $expected_image == e0d4cf6f1c0dbbc09d8a41922b64161d438fdd31b4348ba94872e29f770fb906 ]] || fail 'softdog recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'softdog trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'softdog verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-softdog-clone-v1-generation208-live-v1)
		expected_boot_image=build/storage-layout-stage2-softdog-clone-v1-generation208-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed Generation 208 prewrite source-verifier timeout; runtime passed in 6.95 seconds, only source VERIFY emitted, exact fastboot and cleanup passed, p24 write window never opened; never retry or flash'
		expected_boot_role='consumed Generation 208 prewrite source-verifier timeout; exact fallback, no writes; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-softdog-clone-v1
		expected_bundle=storage-layout-stage2-softdog-clone-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=fb7bde41d24a7883df205bfabfd4d22991bddac684ee8d2258e691861caaad92
		expected_avb_digest=1b2f56659e0de051ae6563f73784beda4d090c398374545dac6c92758e9007c6
		expected_generation_record=5be58b042887f6c012c23241ffb04a08834625688c307adae4bd45ef673bdfab
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 8aab1a2c3eb96fc275caf05f7ea1e99f58197f1c13ecd024bac4ed68d2b277c4 ]] || fail 'softdog clone manifest is not pinned'
		[[ $expected_image == 0b0ca68bdbc0968f25482ad3d38439771b3d919745bc816b3870e29620b7bc99 ]] || fail 'softdog clone recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'softdog clone trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'softdog clone verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-native-postmortem-v2-generation210-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-native-postmortem-v2
		expected_bundle=storage-layout-stage2-native-postmortem-v2
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=45cdaa66a0c87d2f518bdea61495491c6fe9edbd74a455760a747548291c003b
		expected_avb_digest=fe70645b6dc4a7de1fc239596c60d094fc6615436894958da3fe7541c9af2659
		expected_generation_record=228f7f27f52f0575721e7bcc839ea291d4572b68ec97407c57a9cb1df597daff
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == b4dd750fc3493d13512cd602580913c9cd2944c04de6d7e45c4c6eeaa471bfef ]] || fail 'postmortem manifest is not pinned'
		[[ $expected_image == e6b23d66d929a1f62ac9fe83bc47ad682b5e72ac63093976119ed92d93da681f ]] || fail 'postmortem recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'postmortem trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'postmortem verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-softdog-direct-clone-v1-generation211-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-softdog-direct-clone-v1
		expected_bundle=storage-layout-stage2-softdog-direct-clone-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=18a116610e3330cec44443e487e2393a9aa0063b1b333620c8674580c9f81b21
		expected_avb_digest=66a11afc31818a0ed027e126e55c4a6484d579138ea47fbd494999d170924c4b
		expected_generation_record=c9a28b19f1fba7655858c69514c1ea27fc2cd85ea70a96cd0c4fecf98be1e085
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 7dec2c357c4f3e229abf0eb8c71cecfdda71008b4ed2238f0b85040e8e19971b ]] || fail 'direct clone manifest is not pinned'
		[[ $expected_image == dba34fa3af95cfcb766cf1ef89ab23c93f04f22a9e4a3b925f7073947138c5b2 ]] || fail 'direct clone recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'direct clone trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'direct clone verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-direct-chunk1-v1-generation212-live-v1)
		...
		expected_boot_basis='consumed Generation 212 chunk timeout; extents 1-17 passed, extent 18 began without PASS before the 840-second softdog fallback; p24 remains partial; never retry or flash'
		expected_boot_role='consumed Generation 212 direct chunk timeout; exact fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		;;
	storage-layout-stage2-direct-extent18-v1-generation213-live-v1)
		expected_boot_image=build/storage-layout-stage2-direct-extent18-v1-generation213-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed successful Generation 213 extent-18 overwrite; exact PASS, sync, relock, softdog disarm, TARGET_ACCEPTED and slot-A fastboot in 174.265 seconds; never retry or flash'
		expected_boot_role='consumed successful Generation 213 extent-18 overwrite; exact fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-direct-extent18-v1
		expected_bundle=storage-layout-stage2-direct-extent18-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=9037726182ff49f35a7afd914983e34e43b1fa248aa5bc201ddca2844005abd8
		expected_avb_digest=e21dc3b0e3bd5c670421f69afbea7bfe8fcfd843a0cb29ab0d70df83b56f1c21
		expected_generation_record=3c791c18055b98b653e54c6258d207ea8ee1db1da396162e34c8e5de89385444
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 7fde21cb984eade74e369d3da58f12a4e73999d95aeb3582d05cbad304b7a6dd ]] || fail 'extent18 manifest is not pinned'
		[[ $expected_image == e948c69c146442ae085ed3162d3179e01df29d53af1f8bb9e7b7ef0d6306bb09 ]] || fail 'extent18 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'extent18 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'extent18 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-direct-extent19-v1-generation214-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-direct-extent19-v1
		expected_bundle=storage-layout-stage2-direct-extent19-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=3389ce878fe5dcd1a4ed4d9c2ce898e623bbb68d36c0fe37e57151491114a0c7
		expected_avb_digest=8e18ef319fabf504ec59884a7f8b8d3b547d306f17afe187ff5bd202a86603b5
		expected_generation_record=2e21eddc4fc3bf8ac18f63e795f86087c9041d951bccd9de09fc331bd23102e5
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 6459d0b38a3d041d6e696fa5abca22e68fd7d3e6d3eabfcd40a0c25f4788bc9a ]] || fail 'extent19 manifest is not pinned'
		[[ $expected_image == 19045e363124be07e2f0e79be4b19f811654c9c562e429800ce9711f2ae4fd94 ]] || fail 'extent19 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'extent19 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'extent19 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-direct-extent20-seg1-v1-generation215-live-v1)
		expected_boot_image=build/storage-layout-stage2-direct-extent20-seg1-v1-generation215-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed successful Generation 215 extent-20 segment-1 overwrite; exact PASS, sync, relock, softdog disarm, TARGET_ACCEPTED and slot-A fastboot in 480.461 seconds; never retry or flash'
		expected_boot_role='consumed successful Generation 215 extent-20 segment-1 overwrite; exact fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-direct-extent20-seg1-v1
		expected_bundle=storage-layout-stage2-direct-extent20-seg1-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=8ba0b5d46abe6c6b2663c15e609dbe46b9dfbbb2abaff6a69d7ebdc45d34ec93
		expected_avb_digest=841d9223fe0ab8c532718b0fa1ef39a9a2cf351e04130892ef212cc8f8b4e5f3
		expected_generation_record=14b08e28f72841fda0ef44c749d787a2d4f3bf02fdc14ea2aaa57560eed05802
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 140124bc1647493f9c2db270c338397bdb9de71caa9b9e86ca97c760e69def72 ]] || fail 'extent20 segment1 manifest is not pinned'
		[[ $expected_image == bfc0f6c41fca197a46effda1c9c358f1724e52d8bb8272a8bb9e84fc83fcd4be ]] || fail 'extent20 segment1 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'extent20 segment1 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'extent20 segment1 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-direct-extent20-seg2-v1-generation216-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-direct-extent20-seg2-v1
		expected_bundle=storage-layout-stage2-direct-extent20-seg2-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=63ae135a8e7cfe3d4bc691a0f1f58cca2a8b5334d8eab485d2d534555924890f
		expected_avb_digest=6526aa99481c74a7931ff330d593e1f23361bc0086a4e685b9155ec819b8ddb3
		expected_generation_record=50a7c25857d73293cd3e73bb3602d05d41227f9caa80c043aeb74dcbf5ffa0f7
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 774135c181bb33fc8ab799f825f7a9ac97ac11f1d85d8386540348dfad57bf34 ]] || fail 'extent20 segment2 manifest is not pinned'
		[[ $expected_image == ab9923425b67b425bf7a6ad9b6a5c220fe198091ca97ece96f16b908aa060879 ]] || fail 'extent20 segment2 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'extent20 segment2 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'extent20 segment2 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-direct-extent20-seg2a-v1-generation217-live-v1)
		...
		expected_boot_basis='consumed successful Generation 217 extent-20 segment-2A overwrite; exact PASS, sync, relock, softdog disarm, TARGET_ACCEPTED and slot-A fastboot in 296.065 seconds; never retry or flash'
		expected_boot_role='consumed successful Generation 217 extent-20 segment-2A overwrite; exact fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		;;
	storage-layout-stage2-direct-extent20-seg2b-v1-generation218-live-v1)
		expected_boot_image=build/storage-layout-stage2-direct-extent20-seg2b-v1-generation218-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed successful Generation 218 extent-20 segment-2B overwrite; exact PASS, sync, relock, softdog disarm, TARGET_ACCEPTED and slot-A fastboot in 294.734 seconds; never retry or flash'
		expected_boot_role='consumed successful Generation 218 extent-20 segment-2B overwrite; exact fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-direct-extent20-seg2b-v1
		expected_bundle=storage-layout-stage2-direct-extent20-seg2b-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=6000558ab4e4085b7c04295153592544ca95fb049445d5cfba7d907927f3b4c0
		expected_avb_digest=0881c695aa237d0b1754f4ddf57d81eac41c00312539fcc4bc14b15cde7875cc
		expected_generation_record=614054bca3fc0cad6abcef3dfb4d01d420e9f004a0126b082fd0ce37b9b53b31
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == f607405e5fcd04db8f9efc3d42ebcb2202d447eec73b0ca5ebad75c75472f4f2 ]] || fail 'extent20 segment2B manifest is not pinned'
		[[ $expected_image == 5085953bc4c389fed42e89ec8fca37cb380c337eb904215fc719c6aedbad1f70 ]] || fail 'extent20 segment2B recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'extent20 segment2B trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'extent20 segment2B verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-direct-extent20-seg3a-v1-generation219-live-v1)
		expected_boot_image=build/storage-layout-stage2-direct-extent20-seg3a-v1-generation219-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed Generation 219 extent-20 segment-3A hard stall; BEGIN without PASS, NCM unreachable with configured gadget and TX watchdogs, softdog/emergency/fallback failed, p24 partial/unknown; never retry or flash'
		expected_boot_role='consumed Generation 219 segment-3A hard stall without autonomous fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-direct-extent20-seg3a-v1
		expected_bundle=storage-layout-stage2-direct-extent20-seg3a-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=90e6f4f26a744953cde09eb92f0f2e7ba8b51a4de0325b0cd61cd50f13e6a583
		expected_avb_digest=90f0e52b9f3ffe7719ac8ccf406d640a2cb426db073d2dd3e0d438cb36f7c0de
		expected_generation_record=5366e02348ca90b1e2258892f3248038ebb359d507a1236fb0ab7f88741bd118
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == f95bc32ff18a90f4015f3a51603cb875f46eeeb64c18b6735eccf5947b01014f ]] || fail 'extent20 segment3A manifest is not pinned'
		[[ $expected_image == ac55ace2eba58bb2984576e88b4bd58163733cd00b78a0ee85711c185150a6d0 ]] || fail 'extent20 segment3A recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'extent20 segment3A trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'extent20 segment3A verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-native-progress-v1-generation220-live-v1)
		expected_boot_image=build/storage-layout-stage2-native-progress-v1-generation220-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='consumed successful Generation 220 read-only segment-3A progress cycle; exact source SHA, 16384-block p24 prefix, zero mismatch at 1480465, empty pstore inconclusive, TARGET_ACCEPTED and slot-A fastboot in 439.436 seconds; never retry or flash'
		expected_boot_role='consumed successful Generation 220 read-only progress cycle; exact fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-native-progress-v1
		expected_bundle=storage-layout-stage2-native-progress-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=b2568c825df832779dc8359967dac565faace211619da4e5f5bc153e90a4a967
		expected_avb_digest=12d2d82acb7d980d37347981cfcca08d9bc86ec7665282de429ff423b24e2235
		expected_generation_record=25ae063764f5a0d4726cda5cb22c7d334a4162c5282dae217850cdcea9d23de5
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == c6373ab89d55d494c9e4336200ca9fe3399a05c1eb66908e70a359dd77cbaddb ]] || fail 'native progress manifest is not pinned'
		[[ $expected_image == a833700db1b1492ed118a71ad3f4c1a1ae14b845038da2acb374c6f971e6be5e ]] || fail 'native progress recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native progress trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native progress verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-native-verify-v1-generation221-live-v1)
		expected_boot_image=build/storage-layout-stage2-native-verify-v1-generation221-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 221 read-only grown-p24 geometry, UUID, clean-state, seal and boot-critical verification cycle; no storage writes, RAM-only, never flash or retry after COMMIT'
		expected_boot_role='unbooted Generation 221 read-only native-root verifier; never flash or retry after COMMIT'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-native-verify-v1
		expected_bundle=storage-layout-stage2-native-verify-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=06b31d559761d2854576a127019441a2af94cc177a222e3ee55ef62c242a48fb
		expected_avb_digest=e00bb2ffe08be0d431631f7564def7ca6c03cee40a2a29de6549d37333643ace
		expected_generation_record=4d80a242720a65d0170f78aa057e39c1a7a16b9f9a93d1735319f13e94990bcc
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 4767bb1a9b480c1245df34e0f8a926ceaaf9be4686880420d39e6100cbd6c008 ]] || fail 'native verify manifest is not pinned'
		[[ $expected_image == f5bf62e1f62d49a6bd8df8bae8d8ddb889e11651678888b9962a2813520bd01a ]] || fail 'native verify recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native verify trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native verify verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-native-tree-detail-v1-generation222-live-v1)
		expected_boot_image=build/storage-layout-stage2-native-tree-detail-v1-generation222-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 222 read-only per-item p24 metadata and hash classification cycle; no storage writes, RAM-only, never flash or retry after COMMIT'
		expected_boot_role='unbooted Generation 222 read-only per-item native-root classifier; never flash or retry after COMMIT'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-native-tree-detail-v1
		expected_bundle=storage-layout-stage2-native-tree-detail-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=162f62e8537d98836297b5dbc4cb68148875b5771da6b7838e4dcc9ce9df2bf6
		expected_avb_digest=f5289e0e03b60c26b3072a76379aae0c0a06cd177c5a26c238c6543c7818a436
		expected_generation_record=81cc04ac9ede19b236abdb1f426639c5c885a63f478ca06700fd60a38fabde23
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 907b2447757ad3c0e9d7f3d3ffed0e89e044585fddfbf97b6717a63c99e7b9e9 ]] || fail 'native tree detail manifest is not pinned'
		[[ $expected_image == 7ae03ecb424ff3ac4a51f01bbffb5a0d3a39934efaf3de9a489688f9dc628e6a ]] || fail 'native tree detail recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native tree detail trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native tree detail verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	storage-layout-stage2-native-ssh-repair-v1-generation223-live-v1)
		...
		;;
	storage-layout-stage2-native-postrepair-verify-v1-generation224-live-v1)
		expected_boot_image=build/storage-layout-stage2-native-postrepair-verify-v1-generation224-20260827-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 224 read-only postrepair ext4 state and seven-item boot-critical verification cycle; no storage writes, RAM-only, never flash or retry after COMMIT'
		expected_boot_role='unbooted Generation 224 read-only postrepair verifier; never flash or retry after COMMIT'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-native-postrepair-verify-v1
		expected_bundle=storage-layout-stage2-native-postrepair-verify-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=b0ba46822c96e42f2f524973fb788a778611b84f8bee3f8ef0a7a9f6d2252639
		expected_avb_digest=1204b7b3c81ba416c81acc4febe60e8b66a5a7fde8cae1207648edbe446732a6
		expected_generation_record=2452dd1be362f89745cb5499ee9ab93152094a8d31ba3d7c5e743f1c14b5343a
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 7cbec8fedf21126234d164654ac08577be00e0143672fed711874fc6f19b4ba0 ]] || fail 'native postrepair manifest is not pinned'
		[[ $expected_image == 4dc088168db899b82981470b294ff04bc312913d4f277cd903298e6d027e2de0 ]] || fail 'native postrepair recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native postrepair trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native postrepair verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	storage-layout-stage2-native-fsck-v1-generation225-live-v1)
		expected_boot_image=build/storage-layout-stage2-native-fsck-v1-generation225-20260828-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 225 p24-only e2fsck-preen repair after exact clean-with-errors and repaired-tree precheck, 600-second softdog, post-fsck clean/tree proof and relock; RAM-only, never flash or retry after COMMIT'
		expected_boot_role='unbooted Generation 225 p24-only fsck repair; never flash or retry after COMMIT'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=storage-layout-stage2-native-fsck-v1
		expected_bundle=storage-layout-stage2-native-fsck-v1
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=06ccc1ef02f10badb987c3d30eb46101206b17297b8db1e5bd41e7ce559b9c28
		expected_avb_digest=7ceda50d27249f4b7f5c61d54aa84ff90fcc82b5f2bb615ce9361f09add48992
		expected_generation_record=c726f6036dcd8ab3c238325e297bce7293f8060746ab04754c32cb50ed9c1693
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 60db65fda138a675a002f05d49fb9f6bf9e5fabaf4d19c60b13b325415c7f2bd ]] || fail 'native fsck manifest is not pinned'
		[[ $expected_image == 3459568ed88f3f4ae94b58ae20017e1ed944652c9c8cf7e3dce04e022d90d340 ]] || fail 'native fsck recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native fsck trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native fsck verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	persistent-native-root-v1-generation226-live-v1)
		...
		expected_boot_role='consumed Generation 226 native-p24 cycle; switch-root and host-key pin passed, authenticated SSH returned 255 until exact fallback; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		;;
	persistent-native-root-v2-generation227-live-v1)
		expected_boot_image=build/persistent-native-root-v2-generation227-20260828-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 227 RAM-only native-p24 systemd/SSH cycle with volatile-only root account unlock, immutable lower-root proof, password and keyboard auth disabled, charging/UFS evidence and restart2 fallback; no phone storage write, never flash or retry after COMMIT'
		expected_boot_role='consumed Generation 227 native-p24 cycle; switch-root and host-key pin passed, 127 SSH attempts returned 255, exact offline AArch64 controls disproved the locked-root diagnosis, and slot-A recovery fallback passed; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-native-root-v2
		expected_bundle=persistent-native-root-v2
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=43d8795533ecc77293238efdff4b5e77a10a453757cfac83da7aea7268316205
		expected_avb_digest=4fbc7e73b60f578a30d894e28feb44491c9146bc7624a413123778bd4bf75621
		expected_generation_record=5a4e6791d1121957d6f249904072298e09db6e9e9af3f72c289a54f349906ebd
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 6c89b951cc340b4503cc6f6b828f46a04cf6e7508b95dc55a9ca4649a865ea82 ]] || fail 'native root v2 manifest is not pinned'
		[[ $expected_image == 084cd19b6eeda72e079972e5b910b5c143762d64a53bae383b69a8143592896b ]] || fail 'native root v2 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native root v2 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native root v2 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
		...
		;;
	persistent-native-root-v3-generation228-live-v1)
		expected_boot_image=build/persistent-native-root-v3-generation228-20260828-r1/repack/stable-recovery-a.avb.img
		expected_boot_basis='one exact Generation 228 RAM-only native-p24 SSH diagnostic: one client attempt, bounded target OpenSSH/PAM/config/namespace transcript over NCM, direct restart2 fallback, no phone storage write, never flash or retry after COMMIT'
		expected_boot_role='consumed successful Generation 228 first-SSH-attempt discriminator; exact root/key/config state, client timeout while target blocked at PAM initialization, TARGET_ACCEPTED and direct fastboot return; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-native-root-v3
		expected_bundle=persistent-native-root-v3
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=5f9ec7a8215a514785c2c4ae822af712e5f094c3adfd1b48894033f98861e5bd
		expected_avb_digest=ae64a97f5f7c3cd942a4937cd7847526798d3ada5e0582b665fa9cf935d63f1d
		expected_generation_record=6e36c799779a16e3c7212d48ae2bfe45dc085e117a2772b1cd9d59d324ad0cbd
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == b165584d1e335efad249552d9fd3de6554f411149de08aa9dcf9403b608aca1e ]] || fail 'native root v3 manifest is not pinned'
		[[ $expected_image == 7710a1335a51296eaa1214fee854d89d1ed356ff45a7d032f807115ae0cbe612 ]] || fail 'native root v3 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native root v3 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native root v3 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	persistent-native-root-v4-generation229-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-native-root-v4
		expected_bundle=persistent-native-root-v4
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=7a501fd6acc7b99e6799c70f063cb97b272c69c81db4b0e9ccd9c37afb3e878f
		expected_avb_digest=d47e56c915ddc8880649ad3892a7cc0e2a79041f5425dc12a149be521229565a
		expected_generation_record=bf618864b26fe01492f06e615135b646a9caa0d3401f41de9e3f2758d47887f2
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 5ac2a406ba6e132c3b7488830eda125151e6aa532e4b7867f8b962c22c3051a8 ]] || fail 'native root v4 manifest is not pinned'
		[[ $expected_image == 056f2ca56706381223f363a318cdb0364e02b8950e6c60f8cd6a7e3155b633cf ]] || fail 'native root v4 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native root v4 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native root v4 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	persistent-native-root-v5-generation230-live-v1)
		...
		expected_boot_basis='consumed Generation 230 postrepair native-p24 cycle; p24/root/OverlayFS/switch-root, NCM, first key auth and UFS passed; runtime raced the not-yet-present ready marker, later snapshot proved systemd running with zero failed units; exact slot-A fastboot and FALLBACK_RETURNED passed; never retry or flash'
		expected_boot_role='consumed Generation 230; repaired p24, switch-root, first key auth and UFS passed; runtime raced the ready marker, later systemd snapshot passed, exact fastboot returned; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-native-root-v5
		expected_bundle=persistent-native-root-v5
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=25a71d31441a40d870e1ae63967e2701821d2ea052604fa6d836eb66b11bd960
		expected_avb_digest=70d649736301569d92c218ee29b940582f6ae05057290bec7e8a7ee999a31630
		expected_generation_record=044c0c97fb0ef391dda3f967a6d5c668b1f8f827cc3ca56abd35007fd1ae8499
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 2454db0ff2a558d8764c824f0a6c4d82f0212e39714d540163a9f7a865c5d9da ]] || fail 'native root v5 manifest is not pinned'
		[[ $expected_image == a87d564c9249a611bdc38a52cb28cc25bde6743ca0d2e98529c12c2ba7361c9c ]] || fail 'native root v5 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native root v5 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native root v5 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
	...
	persistent-native-root-v6-generation231-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-native-root-v6
		expected_bundle=persistent-native-root-v6
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=d7ac0950dbd066e02e3d6852c3305ba9d7c3f619fd38190174cee4233f2990c5
		expected_avb_digest=90de5962e48064e8c10dbc9e78af805f617c2db85f5beb390802639325b400db
		expected_generation_record=bd4dcb022f41971a78aafadd50fdb38c78b1a991e3959d62fe86c386433dc31e
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 2725e66cc321d9d019d86a298090f89d5bac68df45fda4d807e12bb35ec0497a ]] || fail 'native root v6 manifest is not pinned'
	...
	persistent-native-root-v7-generation232-live-v1)
		...
		expected_boot_basis='consumed successful Generation 232 native-p24 cycle; repaired root, OverlayFS, switch-root, NCM, first key auth, UFS, full systemd readiness, zero failed units and exact slot-A fastboot passed in 255.879 seconds; TARGET_ACCEPTED; never retry or flash'
		expected_boot_role='consumed successful Generation 232; native p24, systemd, key SSH, UFS, NCM and direct exact fastboot passed in 255.879 seconds; never retry or flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
	...
	persistent-native-root-v8-generation233-live-v1)
		...
		expected_verifier=c3c5c31831335867a79c5bcd5999ae67daa6c0f94d76df4522268a493512e3bb
		expected_config=df28224e6e8d2dfc825ac49dc9f6bdeb12bbcdae2dff92cbbf14a8a94177578f
		expected_target_id=persistent-native-root-v8
		expected_bundle=persistent-native-root-v8
		expected_bundle_profile=persistent-root-ro-v1
		expected_target_release=7.1.4-g359318de534f
		expected_target_timeout=600
		expected_avb_salt=82b1a4df08d282977756988b8b8c4890c46d697344ab6aa582cd82ff302d8fe6
		expected_avb_digest=4aa151ceccd0a99b478e49ce9aead843a0b058916538f2313b70773748fcc045
		expected_generation_record=df18222e79ba8581c221f1799cafd9cac84f933e9710723f03f546c75e8c69f8
		recovery_init=$repo/initramfs/recovery-init
		[[ $expected_manifest == 7e57c523fa344808fbf551635993d1e712243cf5a93e82ddc83ac9785ca48992 ]] || fail 'native root v8 manifest is not pinned'
		[[ $expected_image == 5c8bee56d1703e9315be0aa2ddb7bd27d5be6dafc445e07cd27edbb11f41d3b9 ]] || fail 'native root v8 recovery is not pinned'
		[[ $expected_trust == cc1bca69dadbb0ae6f221a3ac5866d0edfebabd9bf96a9e0ef2747e8283f6054 ]] || fail 'native root v8 trust is not pinned'
		[[ $expected_host_verifier == 04f8544a26304af03a67c7588e68e2ff1a480cb500bda4fbf213db2cb650cb29 ]] || fail 'native root v8 verifier is not pinned'
		avbtool=$repo/artifacts/android-boot-tools-v1/avbtool.py
		unpack=$repo/artifacts/android-boot-tools-v1/unpack_bootimg.py
		qualified_cpio=$repo/scripts/host/qualified-cpio-path/cpio
		qualified_cpio_shim=$repo/scripts/host/qualified-tool-shims/cpio
