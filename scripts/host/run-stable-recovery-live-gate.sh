...
case $profile in
	...
	storage-layout-stage2-native-progress-v1-generation220-live-v1)
		...
		expected_boot_basis='one exact Generation 220 read-only p23-source/p24-target segment-3A progress diagnostic with retained recovery pstore, bounded evidence and softdog; no storage writes, RAM-only, never flash or retry after COMMIT'
		expected_boot_role='unbooted Generation 220 read-only native progress observer; never flash or retry after COMMIT'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=7e4c7423bfd0a99b73647f192c8ab08bdc493c038f9d6af601b1b9196ce19648
