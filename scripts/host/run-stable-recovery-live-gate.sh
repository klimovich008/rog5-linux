...
case $profile in
	...
	local-image-stage-prebind-v12-generation121-live-v1)
		...
		expected_boot_basis='one exact Generation 121 full staging cycle with mdev moved before UDC bind; unchanged Image/DTB/address/power-USB/UFS/installer, one exact userdata image path, key-only SSH, RAM-only; never flash or retry after entry'
		expected_boot_role='unbooted Generation 121 full staging successor; exact mature pre-bind mdev ordering, unchanged Image/DTB/power-USB/UFS/one-file installer and fastboot rollback; never flash'
		expected_boot_tracked=no
		component_layout=structured
		expected_kernel=838425a8bc0d49cd92a62df843ca939c3376b879c02faa8bab930d80913c7783
		expected_raw=4f9ac4e7afd4b5bf46a8a79188a0376406fcca294a8cc1648e4f0a44fc82d9f8
