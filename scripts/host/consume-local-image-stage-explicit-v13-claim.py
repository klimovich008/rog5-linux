#!/usr/bin/env python3
"""Enter the fixed Generation-122 claim through the generic consumer."""
...
PROFILE = "local-image-stage-explicit-v13-generation122-live-v1"
EXPECTED = (
    b"format=rog5-temporary-boot-consumption-v1\n"
    b"recovery_profile=local-image-stage-explicit-v13-generation122-live-v1\n"
