#!/usr/bin/env python3
"""Enter the fixed Generation-118 claim through the generic consumer."""
...
PROFILE = "local-image-stage-ncm-v9-generation118-live-v1"
EXPECTED = (
    b"format=rog5-temporary-boot-consumption-v1\n"
    b"recovery_profile=local-image-stage-ncm-v9-generation118-live-v1\n"
