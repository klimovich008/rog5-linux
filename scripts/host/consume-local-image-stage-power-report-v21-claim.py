...
import sys
PROFILE="local-image-stage-power-report-v21-generation130-live-v1"
EXPECTED=(b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=local-image-stage-power-report-v21-generation130-live-v1\n" b"candidate=local-image-stage-power-report-v21\n" b"manifest_sha256=f333316ac70170a7f3f2afc62679633191d47a5103e979f040c9b404d3222915\n" b"state=BOOT_CLAIMED\n")
def main():
