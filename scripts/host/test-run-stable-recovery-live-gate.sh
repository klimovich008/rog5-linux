...
grep -Fq "expected_boot_role='unbooted Generation 146 writer; absent-or-empty nologin and unlocked key-only root account, proven UFS, bounded installer, relock, fastboot; never flash'" "$gate"
