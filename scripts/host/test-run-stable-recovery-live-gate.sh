...
grep -Fq "expected_boot_role='unbooted Generation 143 writer; bounded NM transition fix, proven UFS/SSH target, one image installer, relock, fastboot return; never flash'" "$gate"
