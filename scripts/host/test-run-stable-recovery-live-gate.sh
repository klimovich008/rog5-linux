...
grep -Fq "expected_boot_role='unbooted Generation 140 glob-enabled UFS topology baseline; unchanged ae717 Image/DT/modules and power loader, built-in reboot mode; never flash'" "$gate"
