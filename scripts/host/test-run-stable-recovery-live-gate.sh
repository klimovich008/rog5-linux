...
grep -Fq "expected_boot_role='unbooted Generation 142 writer; removes exact nologin before key-only SSH, proven UFS, bounded image installer, relock, fastboot return; never flash'" "$gate"
