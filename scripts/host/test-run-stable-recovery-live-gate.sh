...
grep -Fq "expected_boot_role='unbooted Generation 152 logical-size-bounded partial classifier plus direct-versus-buffered UFS benchmark; never flash'" "$gate"
