#!/usr/bin/env python3
"""Offline S02–S05/S07 replay: no phone connection, mutation or execution claim."""
import argparse
import ast
...
def main():
    p=argparse.ArgumentParser(description=__doc__);p.add_argument('--kind',choices=('S02','S03','S04','S05','S07'),required=True)
