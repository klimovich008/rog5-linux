#!/usr/bin/env python3
"""Offline S02/S03 replay only: no phone connection, restart or execution claim."""
import argparse
import ast
...
def main():
    p=argparse.ArgumentParser(description=__doc__);p.add_argument('--kind',choices=('S02','S03'),required=True)
