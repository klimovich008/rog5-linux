...
PROFILES.update(
    {
        ...
        "userdata-ext4-reset-generation97-live-v1": (
            b"format=rog5-temporary-boot-consumption-v1\n"
            b"recovery_profile=userdata-ext4-reset-generation97-live-v1\n"
            b"candidate=userdata-ext4-reset-generation97\n"
            b"manifest_sha256="
            b"f6e0ee28e2e007e1809a3c57d36ebcca2420029d7bfa4b6c8a8ba64216e8e1ef\n"
            b"state=BOOT_CLAIMED\n"
        ),
