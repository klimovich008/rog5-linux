...
import sys
PROFILE="local-image-stage-bind-error-v18-generation127-live-v1"
EXPECTED=(b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=local-image-stage-bind-error-v18-generation127-live-v1\n" b"candidate=local-image-stage-bind-error-v18\n" b"manifest_sha256=107b72178980a7eec7cce8e4e38a4d8d00a1ae1060234b1fdc41e38a89b4396b\n" b"state=BOOT_CLAIMED\n")
def main():
