...
import sys
PROFILE="ufs-reboot-baseline-v29-generation138-live-v1"
EXPECTED=(b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=ufs-reboot-baseline-v29-generation138-live-v1\n" b"candidate=ufs-reboot-baseline-v29\n" b"manifest_sha256=836ef28ffcf42c5f883b5456da9348b06f091d532d9855eff2a38fe1280bdf4f\n" b"state=BOOT_CLAIMED\n")
def main():
