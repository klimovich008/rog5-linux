...
export_root=${2:-/var/lib/rog5-network-root-adreno-smmu-v20}
...
[[ $export_root == /var/lib/rog5-network-root-adreno-smmu-v20 ]] ||
...
for helper in "$baseline" "$disarm" "$probe" "$gate" \
	"$reprobe_verifier" "$reprobe_test"; do
...
seal=$stage/etc/rog5/adreno-smmu-v20-export
{
	printf 'diagnostic_generation=v20\n'
...
succeeded=1
echo "PASS prepared isolated v20 Adreno-SMMU export at $export_root"
