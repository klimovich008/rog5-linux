...
FULL_UCSI_CHARGING_SUCCESSOR_BUNDLE = "headless-full-ucsi-charging-v2"
FULL_UCSI_CHARGING_ORDERED_BUNDLE = "headless-full-ucsi-charging-v3"
...
POWER_USB_OBSERVER_BUNDLE = "headless-power-usb-observer-v3"
V3_NETWORK_ROOT_BUNDLES = frozenset(
    {
        ...
        FULL_UCSI_CHARGING_SUCCESSOR_BUNDLE,
        FULL_UCSI_CHARGING_ORDERED_BUNDLE,
        FULL_UCSI_CHARGING_EARLY_BUNDLE,
        FULL_UCSI_CHARGING_EARLY_SUCCESSOR_BUNDLE,
        FULL_UCSI_CHARGING_EARLY_OBSERVABLE_BUNDLE,
        POWER_USB_OBSERVER_BUNDLE,
    }
)
