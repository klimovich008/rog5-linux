...
import sys
PROFILE="local-image-stage-hostfix-v19-generation128-live-v1"
EXPECTED=(b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=local-image-stage-hostfix-v19-generation128-live-v1\n" b"candidate=local-image-stage-hostfix-v19\n" b"manifest_sha256=d5022e9a967bda3171492caba4e4ddf1d5d22bca022cf2b27d2fa1f9e7ef911c\n" b"state=BOOT_CLAIMED\n")
def main():
