#!/usr/bin/env python3
"""Enter the fixed Generation-116 claim through the generic consumer."""
from __future__ import annotations
import importlib.util
from pathlib import Path
import sys
PROFILE = "local-image-stage-udc-v7-generation116-live-v1"
EXPECTED = (b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=local-image-stage-udc-v7-generation116-live-v1\n" b"candidate=local-image-stage-udc-v7\n" b"manifest_sha256=16e4bdecca72d584c2cb00e263d9d3756778edcba7ab670ea2e95e2b601cebf9\n" b"state=BOOT_CLAIMED\n")
def main() -> int:
