...
import sys
PROFILE="local-image-stage-nm-v34-generation143-live-v1"
EXPECTED=(b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=local-image-stage-nm-v34-generation143-live-v1\n" b"candidate=local-image-stage-nm-v34\n" b"manifest_sha256=0179be7e66ac350caf2483ab15df63ef95ddfc76bbc5b56a3bbf7139aa155208\n" b"state=BOOT_CLAIMED\n")
def main():
