#!/usr/bin/env python3
"""Enter the fixed Generation-114 claim through the generic consumer."""
...
PROFILE = "local-image-stage-usbmode-v5-generation114-live-v1"
EXPECTED = (
    b"format=rog5-temporary-boot-consumption-v1\n"
    b"recovery_profile=local-image-stage-usbmode-v5-generation114-live-v1\n"
