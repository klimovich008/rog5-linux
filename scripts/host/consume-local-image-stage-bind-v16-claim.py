#!/usr/bin/env python3
"""Enter the fixed Generation-125 claim through the generic consumer."""
...
PROFILE = "local-image-stage-bind-v16-generation125-live-v1"
EXPECTED = (
    b"format=rog5-temporary-boot-consumption-v1\n"
    b"recovery_profile=local-image-stage-bind-v16-generation125-live-v1\n"
