...
profile=headless-diagnostic-ssh-acceptance-v13-live-v1
tmp=$(mktemp -d)
build_tmp=
cleanup_build_tmp() {
...
[[ $(awk -F '\t' -v name="build/ssh-acceptance-v7-production-20260811-r1/wrapper/repack/stable-recovery-a.avb.img" \
...
generation_root=$production_root/wrapper
