...
PROFILE_ID = "local-image-stage-listener-v22-generation131-live-v1"
BUNDLE = "local-image-stage-listener-v22"
MANIFEST_SHA256 = (
    "84a21be69df111e4b4f539949d9fd3d4f9a0eee46ea6eb05a57d7cbf7d41d680"
)
RECOVERY_SHA256 = (
    "ef44ce1ad9f76e7223b2136beb474ae9f5abf8c64527514243e105c20aa4f654"
)
TRUST_KEY_SHA256 = (
...
CLAIM_RECORD = (
    ...
    b"recovery_profile="
    b"local-image-stage-listener-v22-generation131-live-v1\n"
    b"candidate=local-image-stage-listener-v22\n"
    b"manifest_sha256="
    b"84a21be69df111e4b4f539949d9fd3d4f9a0eee46ea6eb05a57d7cbf7d41d680\n"
    b"state=BOOT_CLAIMED\n"
)
CYCLE.CLAIM_CONSUMER.CLAIMS[PROFILE_ID] = CLAIM_RECORD
CLAIM_ENTRYPOINT = (
    REPO
    / "scripts/host/consume-local-image-stage-listener-v22-claim.py"
)
...
LIVE_ROOT = (
    REPO
    / "build/local-image-stage-listener-v22-generation131-20260824-r1"
)
...
PROFILE = CYCLE.CycleProfile(
    ...
    target_id=BUNDLE,
    admission_profile="local-image-stage-listener-v22",
    recovery_profile=PROFILE_ID,
    runtime_profile="local-image-stage-listener-v22",
    build_profile="local-image-stage-listener-v22",
    diagnostic=False,
)
