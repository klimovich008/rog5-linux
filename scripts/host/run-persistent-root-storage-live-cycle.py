...
PROFILE_ID = "local-image-stage-power-report-v21-generation130-live-v1"
BUNDLE = "local-image-stage-power-report-v21"
MANIFEST_SHA256 = (
    "f333316ac70170a7f3f2afc62679633191d47a5103e979f040c9b404d3222915"
)
RECOVERY_SHA256 = (
    "a1cc3db2cc2ed024728db50d7aa8b6def555990814c9a4861b0fa18ea6ec3923"
)
TRUST_KEY_SHA256 = (
...
CLAIM_RECORD = (
    ...
    b"recovery_profile="
    b"local-image-stage-power-report-v21-generation130-live-v1\n"
    b"candidate=local-image-stage-power-report-v21\n"
    b"manifest_sha256="
    b"f333316ac70170a7f3f2afc62679633191d47a5103e979f040c9b404d3222915\n"
    b"state=BOOT_CLAIMED\n"
)
CYCLE.CLAIM_CONSUMER.CLAIMS[PROFILE_ID] = CLAIM_RECORD
CLAIM_ENTRYPOINT = (
    REPO
    / "scripts/host/consume-local-image-stage-power-report-v21-claim.py"
)
...
LIVE_ROOT = (
    REPO
    / "build/local-image-stage-power-report-v21-generation130-20260824-r1"
)
...
PROFILE = CYCLE.CycleProfile(
    ...
    target_id=BUNDLE,
    admission_profile="local-image-stage-power-report-v21",
    recovery_profile=PROFILE_ID,
    runtime_profile="local-image-stage-power-report-v21",
    build_profile="local-image-stage-power-report-v21",
    diagnostic=False,
)
