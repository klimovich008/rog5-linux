...
PROFILE_ID = "local-image-stage-postbind-v20-generation129-live-v1"
BUNDLE = "local-image-stage-postbind-v20"
MANIFEST_SHA256 = (
    "c38000c3818d0c170eca7150517d127b6feef75819072d56f33f40840cdfba6c"
)
RECOVERY_SHA256 = (
    "53b74a355527114f65004753bef479665d84d16b1fe0a3b1a57684c8dfb3fed0"
)
TRUST_KEY_SHA256 = (
...
CLAIM_RECORD = (
    ...
    b"recovery_profile="
    b"local-image-stage-postbind-v20-generation129-live-v1\n"
    b"candidate=local-image-stage-postbind-v20\n"
    b"manifest_sha256="
    b"c38000c3818d0c170eca7150517d127b6feef75819072d56f33f40840cdfba6c\n"
    b"state=BOOT_CLAIMED\n"
)
CYCLE.CLAIM_CONSUMER.CLAIMS[PROFILE_ID] = CLAIM_RECORD
CLAIM_ENTRYPOINT = (
    REPO
    / "scripts/host/consume-local-image-stage-postbind-v20-claim.py"
)
...
LIVE_ROOT = (
    REPO
    / "build/local-image-stage-postbind-v20-generation129-20260824-r1"
)
...
PROFILE = CYCLE.CycleProfile(
    ...
    target_id=BUNDLE,
    admission_profile="local-image-stage-postbind-v20",
    recovery_profile=PROFILE_ID,
    runtime_profile="local-image-stage-postbind-v20",
    build_profile="local-image-stage-postbind-v20",
    diagnostic=False,
)
