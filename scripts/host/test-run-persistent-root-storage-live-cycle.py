...
class PersistentRootLiveCycleTest(unittest.TestCase):
    ...
    def test_profile_and_artifact_identities_are_exact(self) -> None:
        ...
        self.assertEqual(
            MODULE.BUNDLE,
            "storage-layout-stage2-watchdog-probe-v1",
        )

    def test_watchdog_probe_artifact_and_admission_identities_are_exact(self) -> None:
        self.assertEqual(
    ...
    def test_runner_executes_only_read_only_probe_then_waits_for_fastboot(self) -> None:
        source = MODULE_PATH.read_text()
        for forbidden in (
            "fastboot flash",
            "fastboot erase",
