...
import sys
PROFILE="local-image-stage-of-node-v27-generation136-live-v1"
EXPECTED=(b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=local-image-stage-of-node-v27-generation136-live-v1\n" b"candidate=local-image-stage-of-node-v27\n" b"manifest_sha256=4c10245dfc2651f7eae4c4f466a632b7bd01c04dfe2c81f03354bf8a56159b69\n" b"state=BOOT_CLAIMED\n")
def main():
