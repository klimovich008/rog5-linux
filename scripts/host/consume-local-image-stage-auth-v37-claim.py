...
import sys
PROFILE="local-image-stage-auth-v37-generation146-live-v1"
EXPECTED=(b"format=rog5-temporary-boot-consumption-v1\n" b"recovery_profile=local-image-stage-auth-v37-generation146-live-v1\n" b"candidate=local-image-stage-auth-v37\n" b"manifest_sha256=2d528cbcec4c2b1f19045767921cd12bb181c9e3ee5458e7226f4fb12eead029\n" b"state=BOOT_CLAIMED\n")
def main():
