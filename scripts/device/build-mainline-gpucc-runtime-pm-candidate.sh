...
ORPHAN_RUNTIME_PM_PATCH=${ORPHAN_RUNTIME_PM_PATCH:-$repo/patches/linux-7.1.4/0011-clk-guard-orphan-reparent-with-runtime-PM.patch}
export RCG2_TRACE_PATCH ORPHAN_RUNTIME_PM_PATCH
