...
build_a=${1:?usage: compare-mainline-a660-gmu-clock-preparation-builds.sh BUILD_A BUILD_B}
...
echo 'PASS two clean A660 GMU clock-preparation builds are byte-identical and the clock-preparation MSM module differs only from its accepted v10 predecessor'
