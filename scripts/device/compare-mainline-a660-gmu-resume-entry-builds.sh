...
build_a=${1:?usage: compare-mainline-a660-gmu-resume-entry-builds.sh BUILD_A BUILD_B}
...
echo 'PASS two clean A660 GMU resume-entry builds are byte-identical and the resume-entry MSM module differs only from its accepted v7 predecessor'
