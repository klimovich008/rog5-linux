...
accepted_config=${ACCEPTED_CONFIG:?missing accepted v15 wrapper config}
...
initramfs_sha=8275e22dc5e2894c5bb73bcf25c989c475b6a7e28a6da13b5aa0741e5eb75722
...
echo 'PASS ASUS 5.4.210 wrapper from accepted config; built-in A660 registration staging initramfs; compile-only'
