...
systemd-analyze verify \
	/etc/systemd/system/rog5-power-button.service >/dev/null

echo "PASS staged Arch successor v3 rootfs kernel=$TARGET_KERNEL_RELEASE power-button=press-only-screen-toggle"
