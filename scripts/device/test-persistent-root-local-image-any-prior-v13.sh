...
grep -Fq 'persistent-root-local-image-any-prior-v13-generation106-live-v1' "$runner"
grep -Fq 'build/persistent-root-local-image-any-prior-v13-generation106-20260823-r1' "$runner"
...
echo 'PASS V13 changes only signed identity and runs byte-identical V12 target through one continuous lifecycle'
