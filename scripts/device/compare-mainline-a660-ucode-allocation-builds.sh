...
build_a=${1:?usage: compare-mainline-a660-ucode-allocation-builds.sh BUILD_A BUILD_B}
...
echo 'PASS two clean A660 ucode-allocation builds are byte-identical and the ucode-allocation MSM module differs only from its accepted firmware-only predecessor'
