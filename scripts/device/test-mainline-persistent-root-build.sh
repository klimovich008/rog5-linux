...
grep -Fq 'ae717d919f87b47ea9ed2173ea96660186b62a66' "$verifier"
grep -Fq '939729426dcfa3bd72c75d81c0a675c6f0a193da' "$verifier"
grep -Fq "! grep -q '^CONFIG_SCSI_UFS_DISCOVERY_DATA_WRITE='" "$verifier"
