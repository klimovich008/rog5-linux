...
target=${TARGET:-$repo/scripts/device/load-mainline-recovery.sh}
stage=$(mktemp -d)
...
rog5.recovery_timeout=180 ramoops.mem_address=0x1000000 ramoops.mem_size=0x400000 ramoops.record_size=0x100000 ramoops.console_size=0x100000 ramoops.pmsg_size=0x100000 ramoops.ftrace_size=0 ramoops.dump_oops=1
EOF
...
echo 'PASS exact watchdog allowlist and bounded recovery timeout'
