...
| Recovery control | Reference, native protocol, and signed runtime-bundle verifier pass offline; fetch, same-descriptor load, and image integration remain required |
