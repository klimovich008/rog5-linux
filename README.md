...
policy. No diagnostic image is currently admitted; every successor requires
a distinct identity and complete technical admission before one RAM-only
lifecycle, and no image may ever be flashed.
