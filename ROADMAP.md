...
- [x] Preserve exact UCSI-port, USB-limit, battery, and post-UCSI NCM evidence.
- [ ] Pass the prevention guide's mandatory pre-build checklist from the
  canonical active candidate source; the latest v3 failure is R7 and host-only.
